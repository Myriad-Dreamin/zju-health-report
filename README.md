...
# Run Command
docker run -it --rm -v /home/kamiyoru/work/js/zju-health-report:/data -v /home/kamiyoru/work/js/zju-health-report/dist/conf.js:/app/dist/conf.js --name health-report-container myriaddreamin/health-report
数据提交中, 请稍候...
